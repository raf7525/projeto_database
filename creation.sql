DROP TABLE ENFERMEIRO_QUARTO_PERIODO;
DROP TABLE FATURA;
...
FOREIGN KEY (quartoId) REFERENCES QUARTO (ID_QUARTO) ON DELETE SET NULL
);
...
FOREIGN KEY (PACIENTE_ID) REFERENCES PACIENTE (ID_PACIENTE) ON DELETE CASCADE,
FOREIGN KEY (ID_METODO_PAGAMENTO) REFERENCES METODO_PAGAMENTO (ID_METODO_PAGAMENTO) ON DELETE SET NULL
);
...
DATA_FIM DATETIME,
FOREIGN KEY (ENFERMEIRO_CRE) REFERENCES ENFERMEIRO (CRE) ON DELETE CASCADE,
FOREIGN KEY (quartoId) REFERENCES QUARTO (ID_QUARTO) ON DELETE CASCADE
);
